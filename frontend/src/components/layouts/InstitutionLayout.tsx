...
import { Bell, Menu, LayoutDashboard, Brain, TrendingUp, FileBarChart, LogOut, ClipboardCheck } from 'lucide-react';
...
export const InstitutionLayout = () => {
  ...
  const navigation = [
    ...
    { name: 'Skill Intelligence', href: '/institution/skill-intelligence', icon: Brain },
    { name: 'Placement Analytics', href: '/institution/placements', icon: TrendingUp },
    { name: 'Reports', href: '/institution/reports', icon: FileBarChart },
    { name: 'Student Affiliations', href: '/institution/student-affiliations', icon: ClipboardCheck },
  ];
        ...
        <div className="p-4 border-t border-slate-800">
          <div className="flex items-center gap-3 mb-4 px-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-slate-400 truncate">Institution Admin</p>
            </div>
          </div>
